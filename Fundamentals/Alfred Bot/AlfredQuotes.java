...
public class AlfredQuotes {
    ...
    public String respondBeforeAlexis(String conversation) {
        if(conversation.indexOf("Alexis") != 0){return "Right away, sir. She certainly isn't sophisticated enough for that";}
        else if(conversation.indexOf("Alfred") != 0){return "At your service. As you wish, naturally.";}
